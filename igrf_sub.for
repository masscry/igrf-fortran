...
C 2020.00 07/05/20 GH2(144) -> GH2(196) (Temir Zharaspaev)
C
C*********************************************************************

      subroutine igrf_sub(xlat,xlong,year,height, xl, icode, dip, dec)
c----------------------------------------------------------------
c   INPUT:
...
c----------------------------------------------------------------
      REAL, intent(in) :: xlat, xlong, year, height
      REAL, intent(out) :: xl, icode, dip, dec
      REAL              LATI,LONGI
...
C          COMMON 
C               X(3)    NOT USED
C               H(196)  FIELD MODEL COEFFICIENTS ADJUSTED FOR SHELLG
C-----------------------------------------------------------------------
C  OUTPUT: FL           L-VALUE
...
C*******************************************************************
      REAL, DIMENSION(7), intent(inout) :: P
...
C-----------------------------------------------------------------------
        ...
        CHARACTER*16    FILMOD, FIL1, FIL2           
C ### FILMOD, DTEMOD arrays +1
        DIMENSION       GH1(196),GH2(196),GHA(196),FILMOD(17),DTEMOD(17)
...
c 667  FORMAT('/usr/local/etc/httpd/cgi-bin/natasha/IRI/',A12)
 667  FORMAT(A12)
      ...
      READ (IU, *, IOSTAT=IER, ERR=999) NMAX, ERAD, YEAR                 
C ---------------------------------------------------------------               
...
C ===============================================================    
        ...
        REAL, intent(in) :: DATE, DTE1, DTE2
        INTEGER, intent(in) :: NMAX1, NMAX2
        INTEGER, intent(out) :: NMAX                                    
        REAL, DIMENSION(*), intent(in) :: GH1, GH2                        
        REAL, DIMENSION(*), intent(out) :: GH     
